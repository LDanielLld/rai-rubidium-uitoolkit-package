...
namespace UIInterface
{
    ...
    public class ScoreDisplay
    {
        ...
        #region Animacion de puntuacion
        /// <summary>
        /// Gestor de animacion del texto de puntuación al cambiar de valores
        /// </summary>
        /// <param name="rect"></param>
        /*void AnimateScore(RectTransform rect)
        {
            // Animación simple de escala
            if (scoreRoutine != null) StopCoroutine(scoreRoutine);
            scoreRoutine = StartCoroutine(ScalePunch(lblScore.rectTransform, 1.2f, 0.1f));
        }*/

        /// <summary>
        /// Animacion en codigo para la escala del texto, y que vuelva a su tamaño original
        /// al cabo de un pequeño tiempo
        /// </summary>
        /// <param name="target"></param>
        /// <param name="scale"></param>
        /// <param name="duration"></param>
        /// <returns></returns>
        private IEnumerator ScalePunch(RectTransform target, float scale, float duration)
        {
            ...
            while (t < duration)
            {
                t += Time.deltaTime;
                float lerp = t / duration;
                target.localScale = Vector3.Lerp(targetScale, original, lerp);
                yield return null;
            }
